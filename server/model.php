...
function updateMovies($name, $year, $length, $description, $director, $id_category,$image, $trailer, $min_age){
    ...
    $sql = "REPLACE INTO Repas (name , year, lenth, description, director, id category, image, trailer, min_age) 
            VALUES (:name , :year, :lenth, :description, :director, :id category, :image, :trailer, :min_age)";
    // Prépare la requête SQL
    $stmt = $cnx->prepare($sql);
